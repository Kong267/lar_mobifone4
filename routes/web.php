...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('slider')->group(function () {
        ...
        Route::post('/addSlider', [
            AdminSliderController::class,
            'as' => 'slider.addSlider',
            'uses' => 'AdminSliderController@addSlider'
        ]);
        ...
        Route::post('/updateSlider/{id}', [
            AdminSliderController::class,
            'as' => 'slider.updateSlider',
            'uses' => 'AdminSliderController@updateSlider'
        ]);
        ...
        Route::get('/del/{id}', [
            AdminSliderController::class,
            'as' => 'slider.del',
            'uses' => 'AdminSliderController@del'
        ]);
